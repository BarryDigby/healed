...
class TestSamtoolsFaidx:
    def test_samtools_faidx(self):
        ...
        expected_output = glob(pjoin(os.getcwd(), "work", "*", "*", "*fai"))[0]
...
class TestSamtoolsCoverage:
    def test_samtools_coverage(self):
        ...
        expected_output = pjoin(
            os.getcwd(), "null", "test_dataset", "test_patient", "test_run", "samtools_coverage", "test.bam.coverage"
        )
...
class TestSamtoolsIndex:
    def test_samtools_index(self):
        ...
        expected_output = glob(pjoin(os.getcwd(), "work", "*", "*", "*bai"))[0]
...
class TestSamtoolsRmdup:
    def test_samtools_rmdup(self):
        ...
        expected_output = glob(pjoin(os.getcwd(), "work", "*", "*", "*rmdup.bam"))[0]
...
class TestSamtoolsSort:
    def test_samtools_sort(self):
        ...
        expected_output = glob(pjoin(os.getcwd(), "work", "*", "*", "*sorted.bam"))[0]
...
class TestSamtoolsStats:
    def test_samtools_stats(self):
        ...
        expected_output = pjoin(
            os.getcwd(), "null", "test_dataset", "test_patient", "test_run", "samtools_stats", "test.bam.stats"
        )
...
class TestSamtoolsView:
    def test_samtools_view(self):
        ...
        expected_output = glob(pjoin(os.getcwd(), "work", "*", "*", "*bam.bam"))[0]
