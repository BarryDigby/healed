...
class TestBcftoolsSort:
    ...
    def test_bcftools_sort(self):
        ...
        cmd = ['nextflow', 'test_bcftools.nf', '-entry', 'test_bcftools_sort', '--pwd',  os.getcwd(), '-config', 'test_bcftools.config', '--no-resume']
        subprocess.run(cmd)

        expected_output = pjoin(os.getcwd(), 'null', 'test_dataset', 'test_patient', 'test_run', 'bcftools_sort', 'test_1.sorted.vcf')
    ...
    def test_bcftools_sort_gzipped(self):
        ...
        cmd = ['nextflow', 'test_bcftools.nf', '-entry', 'test_bcftools_sort_gzipped', '--pwd',  os.getcwd(), '-config', 'test_bcftools.config', '--no-resume']
        subprocess.run(cmd)

        expected_output = pjoin(os.getcwd(), 'null', 'test_dataset', 'test_patient', 'test_run', 'bcftools_sort', 'test_2.sorted.vcf')
